...
#We'll need two additional packages: the dplyr and tidyr packages
...
#First we need to get the data together into the right format to use for ggplot
...
#Ok, now let's use the ggplot2 library
library(ggplot2)
